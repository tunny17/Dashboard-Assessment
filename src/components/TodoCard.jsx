...
const TodoCard = ({todo}) => {
    ...
    const { id, subtitle1, subtitle2, image, color } = todo;
    ...
    return (
    <div>
        <Card sx={{ maxWidth: 266.67, maxHeight: 446 }}>

            <CardMedia component='img' height='194' sx={{ padding: '5% 5% 0 5%' }} image={image} alt='test' />
            ...
            <Slider defaultValue={50} aria-label="Disabled slider" className="slider"   sx={{ color: {color}, height: '8px' }} />
